...
> **Status (BRAND_R0, 2026-09-03):** this file is a **current-state baseline** captured 2026-04-27 (#558). Its "without redesigning the brand/UI" scope is superseded for BRAND_R1 by [`docs/architecture/brand-refresh-decision.md`](architecture/brand-refresh-decision.md) §4; the route contract and legacy redirects in §8–§9 remain binding. The body below is unchanged apart from Prettier formatting; it is the reference BRAND_R1_DESIGN diffs against.
