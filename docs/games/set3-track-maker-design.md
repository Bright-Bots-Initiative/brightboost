...
| **9. Safe exploration** (contract added after this doc)        | ✅ By construction: deterministic variation mode (the unknown is the child's own design), visible consequences on every ride, re-edit as the safe way back, no chance-based mastery/XP. Future revisions answer the full Safe Exploration Contract explicitly. |
