...
| -------------------------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------- |
| `jack/test-671-cypress-rebuild`              | [#750](https://github.com/Bright-Bots-Initiative/brightboost/pull/750) | Open · head `fe213e1b` · Alice + nwalker re-requested · `e2e-flows` Essential/required (#774) | Jack / Build reviewers | Await re-review; nwalker sets required check before merge; **do not force-push**                         |
...
| `jack/spike-730-shared-engine`               | [#743](https://github.com/Bright-Bots-Initiative/brightboost/pull/743) | Open · §9.1 **S-2 accepted**; freshness guard → **#720**                                      | nwalker (Railway)      | Railway backend build verification; then merge                                                           |

Related (not in table): **#776** open, **blocked by #760** (must not land first). **#775** open until policy lands in `docs/ci.md` with the #709 map commit. **#709** administrative — nwalker decides close-or-not.
