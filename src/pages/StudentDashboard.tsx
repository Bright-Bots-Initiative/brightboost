  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-black text-slate-800">Hi, {user?.name || "Explorer"}! 👋</h1>
      </div>
      ...
      <div className="mb-8">
        ...
        >
            ...
            <Button variant="secondary" size="lg" className="w-full font-bold text-blue-700">
                Play Next Lesson
            </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
        <Card className="hover:shadow-lg transition cursor-pointer border-l-4 border-l-green-400" onClick={() => navigate("/modules")}>
          <CardHeader>
        ...
        <Card className="hover:shadow-lg transition cursor-pointer border-l-4 border-l-purple-400" onClick={() => navigate("/avatar")}>
          <CardHeader>
