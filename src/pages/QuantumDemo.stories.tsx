    ...
    mockData: [
      {
        ...
        status: 200,
        response:
          "<html><body><canvas>Mocked Qubit Game</canvas></body></html>",
      },
    ],
  },
  decorators: [
      ...
      document.createElement = function (tagName: string) {
        if (tagName.toLowerCase() === "iframe") {
          ...
          mockIframe.innerHTML =
            '<div style="text-align: center; color: #666;"><h3>Mocked Qubit Game</h3><p>Canvas would appear here</p></div>';
    ...
    (Story) => {
      ...
      document.createElement = function (tagName: string) {
        if (tagName.toLowerCase() === "iframe") {
          ...
          mockIframe.style.backgroundColor = "#f0f0f0";
          mockIframe.innerHTML =
            '<div style="text-align: center; color: #666;"><div class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500 mx-auto mb-4"></div><p>Loading Quantum Demo...</p></div>';
          setTimeout(() => {
